<x-admin-layout>
    ...
    <div class="col-m-12 float-right">
        <a href="{{ route('admin.menus.index') }}" class="btn btn-info btn-icon-split">
            ...
            <span class="text">Back to Reservations </span>
        </a>
    </div>
                ...
                <div class="m-2 p-2 bg-slate-100 rounded">
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        <form method="POST" action="{{ route('admin.reservations.update', $reservation->id) }}">
                            ...
                            <div class="sm:col-span-6 mt-3">
                                <label for="tel_number" class="block text-sm font-medium text-gray-700"> Reservation Date  </label>
                                <div class="mt-1">
                            ...
                            <div class="sm:col-span-6 mt-3">
                                ...
                                <div class="mt-1">
                                    <select id="table_id" name="table_id" class="form-multiselect block w-full mt-1 border border-gray-400 rounded-md py-2 px-3">
